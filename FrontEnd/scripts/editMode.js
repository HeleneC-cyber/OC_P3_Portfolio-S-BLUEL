...
export function generateEditMode() {
    ...
    const parentElement = getTag('nav ul li:nth-child(3)')
    const navLoginElement = getTag('a[href="login.html"]')
    ...
    const editBar = createTag("aside", "edit-bar")
    const innerEditBar = `
    ...
    const editTool = createTag("div", "edit-tool")
    const innerEditTool = `
    ...
    const siblingEditTool = getTag("#portfolio h2")
    const parentEditTool = createTag("div", "title-tool-wrapper")

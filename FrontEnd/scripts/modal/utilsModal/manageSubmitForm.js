...
export const manageSubmitForm = (modalGalleryElements, modalGalleryWrap, inputFile, inputTitle, selectCategory, validateBtnModal,modalForm, inputFileBackground, inputFileWrap, descriptionFile) => {
    ...
    modalForm.addEventListener("submit", async (e) => {
        ...
        if (validateBtnModal.classList.contains("background-validate")) {
            ...
            if (response.ok) {
                ...
                manageNewWorkFirstView(modalGalleryElements, modalGalleryWrap, newWork)
...
const manageNewWorkFirstView = (modalGalleryElements, modalGalleryWrap, newWork) => {
